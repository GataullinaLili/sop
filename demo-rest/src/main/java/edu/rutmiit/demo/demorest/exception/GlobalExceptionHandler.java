...
import edu.rutmiit.demo.medicinescontract.dto.StatusResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InnAlreadyExistsException.class)
    public ResponseEntity<StatusResponse> handleInnAlreadyExists(InnAlreadyExistsException ex) {
        return ResponseEntity
